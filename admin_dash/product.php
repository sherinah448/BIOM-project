...
<head>
    ...
    <title>Global Paints -upload Product</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload the product</h1>

                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Upload Product</h6>
                                </div>
                                <div class="card-body">
                                    ...
                                    $category_query = "SELECT DISTINCT category_name, subcategory_name FROM categories";
                                    ...
                                    <script>
                                        ...
                                        function updateSubcategories() {
                                            ...
                                            if (categories[category]) {
                                                categories[category].forEach(function(subcat) {
